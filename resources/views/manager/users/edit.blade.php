        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
                    <h3 class="text-lg font-semibold text-white">Edit Informasi User</h3>
                    <p class="text-blue-100 text-sm">Perbarui data user {{ $user->name }}</p>
                </div>
                
                <form method="POST" action="{{ route('manager.users.update', $user) }}" class="p-6 space-y-6">
                    @csrf
                    @method('PATCH')
