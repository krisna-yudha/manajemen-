            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="@if(Auth::check() && Auth::user()->role === 'manager'){{ route('manager.dashboard') }}@elseif(Auth::check() && Auth::user()->role === 'gudang'){{ route('gudang.dashboard') }}@elseif(Auth::check()){{ route('member.dashboard') }}@else{{ route('login') }}@endif" class="flex items-center">
                        ...
                        <span class="text-xl font-bold text-gray-900">Manajemen</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::check() && Auth::user()->role === 'manager')
                        ...
                        <x-nav-link :href="route('manager.report.barang')" :active="request()->routeIs('manager.report.barang')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            Reports
                        </x-nav-link>
                        <x-nav-link :href="route('components-demo')" :active="request()->routeIs('components-demo')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif(Auth::check() && Auth::user()->role === 'gudang')
                        ...
                        <x-nav-link :href="route('barang.index')" :active="request()->routeIs('barang.*')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                            </svg>
                            Kelola Barang
                        </x-nav-link>
                        <x-nav-link :href="route('rental.pending.gudang')" :active="request()->routeIs('rental.pending.gudang')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <x-nav-link :href="route('maintenance.barang')" :active="request()->routeIs('maintenance.*')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif(Auth::check() && Auth::user()->role === 'member')
                        ...
                        <x-nav-link :href="route('member.barang.available')" :active="request()->routeIs('member.barang.available')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <x-nav-link :href="route('member.rental.create')" :active="request()->routeIs('member.rental.create')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white border-t border-gray-200">
        <div class="pt-2 pb-3 space-y-1 px-4">
            @if(Auth::check() && Auth::user()->role === 'manager')
                ...
                <x-responsive-nav-link :href="route('manager.report.barang')" :active="request()->routeIs('manager.report.barang')" class="flex items-center">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                    Reports
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('components-demo')" :active="request()->routeIs('components-demo')" class="flex items-center">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                    UI Demo
            ...
            @elseif(Auth::check() && Auth::user()->role === 'gudang')
                ...
                <x-responsive-nav-link :href="route('barang.index')" :active="request()->routeIs('barang.*')" class="flex items-center">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                    </svg>
                    Kelola Barang
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('rental.pending.gudang')" :active="request()->routeIs('rental.pending.gudang')" class="flex items-center">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    Approval
            ...
            @elseif(Auth::check() && Auth::user()->role === 'member')
                ...
                <x-responsive-nav-link :href="route('member.barang.available')" :active="request()->routeIs('member.barang.available')" class="flex items-center">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                    </svg>
                ...
                <x-responsive-nav-link :href="route('member.rental.create')" :active="request()->routeIs('member.rental.create')" class="flex items-center">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                    Ajukan Rental
